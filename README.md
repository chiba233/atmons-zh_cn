...
All the Mons 的简体中文汉化补丁，**同时支持 1.2.0 与 1.3.0**，每个整合包版本一个专属包。
...
| 整合包版本 | NeoForge |
|---|---|
| All the Mons **1.3.0** | 21.1.249 |
| All the Mons **1.2.0** | 21.1.248 |
...
文件名里有两个版本号：`r1` 是**补丁的版本**，`mons1.3.0` 才是**你的整合包版本**。认后者下载。
...
- **专有名词**：画作署名 PKMNCC / Gootastic、模型作者 LostMyself / TedXenon、地图模组名 BlueMap。
...
- **天境模组内置的「物品能力提示」资源包**——整合包默认没启用它，装不装本包都不显示。
